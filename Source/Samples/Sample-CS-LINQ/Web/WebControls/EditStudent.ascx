<%@ Control CodeBehind="EditStudent.ascx.cs" Inherits="QuantumConcepts.CodeGenerator.Sample.Web.WebControls.EditStudent" Language="C#" %>

<div class="Field"><span class="Label">Major:</span><span class="Input"><asp:DropDownList ID="MajorField" runat="server" AppendDataBoundItems="true" DataValueField="ID" DataTextField="Name" /></span></div>
