	...
	public partial class EditCourse : BaseUserControl
	{
        ...
        protected void SaveButton_Click(object sender, EventArgs e)
        {
            if (this.ObjectID.HasValue)
            {
				...
				obj.Status = (DataAccess.CourseStatus)Enum.Parse(typeof(DataAccess.CourseStatus), this.CourseStatusField.SelectedValue);
            ...
            {
            	Course obj = CourseLogic.CreateCourse(this.DataContext, int.Parse(this.SemesterField.SelectedValue), int.Parse(this.TeacherField.SelectedValue), this.NumberField.Text, this.NameField.Text, (DataAccess.CourseStatus)Enum.Parse(typeof(DataAccess.CourseStatus), this.CourseStatusField.SelectedValue));
