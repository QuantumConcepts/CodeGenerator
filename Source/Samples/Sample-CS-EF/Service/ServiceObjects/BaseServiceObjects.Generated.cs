...
namespace  QuantumConcepts.CodeGenerator.Sample.Service.ServiceObjects
{
	...
	[DataContract]
	public abstract partial class Course : DataAccess.Course
	{
	...
	[DataContract]
	public abstract partial class Enrollment : DataAccess.Enrollment
	{
	...
	[DataContract]
	public abstract partial class Major : DataAccess.Major
	{
	...
	[DataContract]
	public abstract partial class Semester : DataAccess.Semester
	{
	...
	[DataContract]
	public abstract partial class Student : DataAccess.Student
	{
	...
	[DataContract]
	public abstract partial class Teacher : DataAccess.Teacher
	{
