...
namespace QuantumConcepts.CodeGenerator.Core.ProjectSchema {
    ...
    public class API : IProjectSchemaElement, IHasReturnParameter<API>, IHasParameters<API>, IHasAnnotations<API>, IHasAttributes<API> {
        ...
        private Entity _tableMapping = null;
        ...
        public static API CreateValueTypeCreateAPI(Entity tableMapping) {
            ...
            foreach (Property cm in (from cm in tableMapping.NonPrimaryKeyColumnMappings
        ...
        public static API CreateObjectCreateAPI(Entity tableMapping) {
            API api = new API(API.APIType.Create, "Create" + tableMapping.ClassName, Parameter<API>.CreateDataObjectReturnParameter(tableMapping, Parameter<API>.ParameterQuantifier.Single, null, null), null, new List<Annotation<API>> { new Annotation<API>("summary", "Creates a new " + tableMapping.ClassName + " using the passed-in parameter value(s).", null) }, null);
            ...
            foreach (Property cm in (from cm in tableMapping.NonPrimaryKeyColumnMappings
                                     ...
                                     select cm)) {
                Parameter<API> parameter = null;
                EntityRelationship foreignKeyMapping = tableMapping.ContainingProject.ForeignKeyMappings.Where(fkm => fkm.ReferencedColumnMapping == cm).SingleOrDefault();
                ...
                if (cm.IsEnumeration)
                    ...
                    parameter = Parameter<API>.CreateOtherParameter(foreignKeyMapping.FieldName, Parameter<API>.ParameterModifier.None, Parameter<API>.ParameterQuantifier.Single, cm.Entity.ClassName, false, null, null);
                else
                    parameter = Parameter<API>.CreateOtherParameter(cm.FieldName, Parameter<API>.ParameterModifier.None, Parameter<API>.ParameterQuantifier.Single, cm.DataType, cm.Nullable, null, null);
        ...
        public static API CreateDeleteAPI(Entity tableMapping) {
            ...
            foreach (Property cm in tableMapping.PrimaryKeyColumnMappings) {
